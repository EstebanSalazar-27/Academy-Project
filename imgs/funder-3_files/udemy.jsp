...
if (typeof usi_commons === 'undefined') {
	usi_commons = {
		...
		load_script:function(source, callback) {
			...
			var usi_appender = "";
			if (source.indexOf("product_recommendations.jsp") == -1 && source.indexOf("_pixel.jsp") == -1) {
